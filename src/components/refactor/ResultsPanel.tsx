...
import { AlertTriangle, CheckCircle, FileText, Bot, Terminal, DatabaseZap } from "lucide-react";
    ...
    if (!result) {
        return (
            <div className="text-center text-muted-foreground py-16">
                ...
                <p className="mt-1 text-sm">Your results will appear here after running an action.</p>
            </div>
        );
    }
      ...
      <Tabs defaultValue="summary" className="w-full">
            ...
            <Card>
                ...
                <CardContent className="space-y-2 text-sm">
                   <div className="flex items-center gap-2">
                    ...
                    {result.apply !== undefined && <p><span className="font-medium">Mode:</span> {result.apply ? "Apply" : "Preview"}</p>}
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {codefix.files.length > 0 ? codefix.files.map(file => (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={2} className="text-center text-muted-foreground">No files were changed.</TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        </Table>
        ...
        <TabsContent value="logs" className="mt-4">
            <Card>
                ...
                <CardContent>
                    <CodeBlock code={dbLog || log || "No logs available."} />
                </CardContent>
            </Card>
        </TabsContent>
      </Tabs>
